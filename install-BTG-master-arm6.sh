...
# Get Repo
cd /$BASE
git clone https://github.com/BTCGPU/BTCGPU.git bitcoingold
...
~/nimble-scripts/berkeleydb-installation.sh /$BASE/bitcoingold/
...
# # Build
./autogen.sh
export BDB_PREFIX=/$BASE/bitcoingold/db4
./configure --prefix=/$BASE/bitcoingold/depends/x86_64-pc-linux-gnu/ BDB_LIBS="-L${BDB_PREFIX}/lib -ldb_cxx-4.8" BDB_CFLAGS="-I${BDB_PREFIX}/include" --enable-cxx --disable-shared --with-pic --disable-tests CXXFLAGS=" --param ggc-min-expand=1 --param ggc-min-heapsize=32768"
make

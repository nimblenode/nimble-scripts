...
# Get Repo
cd /$BASE
git clone https://github.com/litecoin-project/litecoin.git litecoin
...
~/nimble-scripts/berkeleydb-installation.sh /$BASE/litecoin/
...
# # Build
./autogen.sh
export BDB_PREFIX=/$BASE/litecoin/db4
./configure --prefix=/$BASE/litecoin/depends/x86_64-pc-linux-gnu/ BDB_LIBS="-L${BDB_PREFIX}/lib -ldb_cxx-4.8" BDB_CFLAGS="-I${BDB_PREFIX}/include" --enable-cxx --disable-shared --with-pic --disable-tests CXXFLAGS=" --param ggc-min-expand=1 --param ggc-min-heapsize=32768"
make

...
# Get Repo
cd /$BASE
git clone https://github.com/zcash/zcash.git zcash
...
~/nimble-scripts/berkeleydb-installation.sh /$BASE/zcash/
...
# # Build
./autogen.sh
export BDB_PREFIX=/$BASE/zcash/db4
./configure --prefix=/$BASE/zcash/depends/x86_64-pc-linux-gnu/ BDB_LIBS="-L${BDB_PREFIX}/lib -ldb_cxx-4.8" BDB_CFLAGS="-I${BDB_PREFIX}/include" --enable-cxx --disable-shared --with-pic --disable-tests CXXFLAGS=" --param ggc-min-expand=1 --param ggc-min-heapsize=32768"
make
